...
const ActivityTrackerForm = () => {
  ...
  // Fetch background image from Unsplash API using localStorage category
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 max-h-40 overflow-y-auto">
                  {availableMembers.map((member) => (
                    <label
                      key={member}
                      className={`flex items-center gap-2 p-3 rounded-lg cursor-pointer transition-all duration-200 backdrop-blur-sm ${
