            ...
            {formData.paymentType === 'individual' && (
              <div className="group">
                ...
                {loadingFriends ? (
                  ...
                  <div className="max-h-32 sm:max-h-48 overflow-y-auto space-y-2 bg-white/10 backdrop-blur-sm rounded-2xl p-3 sm:p-4">
                    {friends.map((friend) => (
                      <label
                        key={friend.id}
                        className="flex items-center p-2 sm:p-3 rounded-xl hover:bg-white/10 cursor-pointer transition-all duration-300"
                      >
                        <input
                          type="checkbox"
          ...
          {message && !friendError && (
            <div className="mt-6 mb-4 md:mb-8 bg-gradient-to-r from-green-500 to-emerald-500 text-white p-4 sm:p-5 rounded-xl shadow-xl animate-transport-arrival">
              <div className="flex items-center">
                ...
                <span className="font-semibold text-sm sm:text-lg">Thank you</span>
              </div>
            </div>
          )}
